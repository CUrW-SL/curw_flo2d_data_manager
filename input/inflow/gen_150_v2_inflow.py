...
def prepare_inflow_150_v2(inflow_file_path, start, end, discharge_id, curw_sim_pool):
    ...
    try:
        ...
        inflow.append('0           37814')
        inflow.append('C               0           37814')
        inflow.append('H               0               0')
...
def usage():
    usageText = """
    --------------------------------
    Prepare inflow for Flo2D 150_v2
    --------------------------------
    
    Usage: .\input\inflow\gen_150_v2_inflow.py [-s "YYYY-MM-DD HH:MM:SS"] [-e "YYYY-MM-DD HH:MM:SS"] [-d "directory_path"] 
    [-M XXX] [-E]
...
if __name__ == "__main__":
    ...
    try:
        ...
        config = json.loads(open(os.path.join(ROOT_DIRECTORY, "input", "inflow", "config_150_v2.json")).read())
        ...
        if not os.path.isfile(inflow_file_path):
            ...
            prepare_inflow_150_v2(inflow_file_path, start=start_time, end=end_time, discharge_id=discharge_id,
